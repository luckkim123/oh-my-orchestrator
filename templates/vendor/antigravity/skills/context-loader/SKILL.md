...
3. **If the task names a library, read `.orchestration/knowledge/libraries/<name>.md`.**
   Its constraints and avoid-patterns override your defaults for this project.

4. **If the task is research-shaped, check `.orchestration/knowledge/research/`**
   before searching. Someone may already have answered it.
...
| `.orchestration/knowledge/research/` | Whichever role was asked to research. Append; do not overwrite another role's note. |
| `.orchestration/knowledge/libraries/` | Whoever verified the behavior, following `_TEMPLATE.md` section order. |
